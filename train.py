...
from latent_kp_gan.ops import conv2d_gradfix
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="LatentKeypointGAN trainer")

    parser.add_argument("path", type=str, help="path to the lmdb dataset")
    parser.add_argument('--arch', type=str, default='latent_kp_gan')
    parser.add_argument(
